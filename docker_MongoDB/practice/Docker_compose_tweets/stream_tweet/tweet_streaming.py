...
#start an engine
engine = sqlalchemy.create_engine('postgresql://postgres:2345@tweetsdb:5432/postgres')
...
class MaxTweetsListener(StreamListener):
    ...
    def on_status(self, status):
        ...
        engine.execute(f'''INSERT INTO tweets VALUES ('{tweet["text"]}', '{tweet["username"]}', '{tweet["followers_count"]}'); ''')
        logging.critical('inserted into databse!') 

        #print('New tweet arrived:', tweet["text"],tweet['username'],tweet['followers_count'])

...
# Read image
image = cv2.imread('bigger_gesicht.jpg')
...
path= '/Users/lilycheng/Desktop/streamlit/'
cv2.imwrite(os.path.join(path,'cat_0.5.jpg'),image)
cv2.imwrite(os.path.join(path,'cat_without_nms.jpg'),org)
cv2.waitKey(0)
